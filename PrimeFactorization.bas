...
140 N = INT(VAL(IN$)) : IF N < 1 THEN GOSUB 5500 : GOTO 90 : REM error message
...
165 REM PRINT LP; " primes up to "; MP; " (sqrt("; N; ")):" : FOR I = 0 TO LP - 1 : PRINT PR(I); " "; : NEXT I : PRINT : REM debugging
